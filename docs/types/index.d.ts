...
/**
* Interface for filling strided arrays with pseudorandom numbers drawn from a Bernoulli distribution.
*/
interface Random extends PRNG {
	...
	*/
	<T = unknown>( N: number, p: Collection<number>, sp: number, out: Collection<T>, so: number ): Collection<T | number>;

	/**
	* Fills a strided array with pseudorandom numbers drawn from a Bernoulli distribution using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param p - success probability
	* @param sp - `p` strided length
	...
	*/
	ndarray<T = unknown>( N: number, p: Collection<number>, sp: number, op: number, out: Collection<T>, so: number, oo: number ): Collection<T | number>;
}
...
interface Routine extends Random {
	/**
	* Returns a function for filling strided arrays with pseudorandom numbers drawn from a Bernoulli distribution.
	*
