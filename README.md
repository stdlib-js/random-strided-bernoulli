...
```javascript
import bernoulli from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-bernoulli@v0.1.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-strided-bernoulli/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/random-strided-bernoulli/actions/workflows/test.yml?query=branch:v0.1.2
